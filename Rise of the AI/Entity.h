...
enum AIType { WALKER, GUARD, JUMPER, PATROLLER };
...
public:
    ...
    bool m_player_hit_left = false;
    bool m_player_hit_right = false;
    bool m_player_hit_top = false;
    bool m_player_hit_bottom = false;
    ...
    int        const hit_wall()           const { return m_left_wall | m_right_wall; }
    bool       const player_hit_enemy()   const { return m_player_hit_top; }
    bool       const enemy_hit_player()   const { return m_player_hit_left || m_player_hit_right || m_player_hit_bottom; }
