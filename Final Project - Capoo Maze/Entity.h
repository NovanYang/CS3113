...
private:
    ...
    int* m_animation_attack_right = NULL; // move to the right
    int* m_animation_attack_left = NULL; // move to the left
    int* m_animation_attack_up = NULL; // move upwards
    int* m_animation_attack_down = NULL; // move downwards
